...
You can also use the tool provided by Xdebug developers: [Xdebug Wizard](http://xdebug.org/wizard.php) You can copy and paste in your phpinfo output. It will give you the correct version to download.
